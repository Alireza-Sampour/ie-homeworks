  ...
  render() {
    const info = [
      ...
      },
      {
        ...
        desc: "یک صفحه طراحی کنید که متن یک بلاگ به همراه اطلاعات نویسنده (شامل عکس، تعداد مطالب، بیوگرافی، تعداد کامنت‌ها، تعداد لایک‌ها، تاریخ ارسال مطلب و برچسب‌ها) را نمایش دهد. کاربر باید بتواند مطلب را نشانه‌گذاری کند و یا در شبکه‌های اجتماعی به اشتراک بگذارد. هر مطلب شامل نویسنده، متن و یک تصویر است.",
      },
      {
        title: "مترونوم",
          ...
          return (
            <div className="col-md-4" key={i}>
              <div className="service-card">
                <Link to={`/${this.props.routes[i].path}`} style={{textDecoration: 'none'}}>
